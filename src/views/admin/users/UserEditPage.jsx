    ...
    <div className="max-w-5xl mx-auto">
      <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
        ...
        <div className="px-4 sm:px-6 py-4 border-b border-slate-100">
          <h1 className="text-base font-bold text-slate-900">Edit User</h1>
          <p className="text-xs text-slate-400 mt-0.5">
            Updating <span className="font-semibold text-brand-600">{user?.name}</span>
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="px-4 sm:px-6 py-6 space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <SelectField label="Role" field="role" options={ROLES} formData={form} errors={fieldErrors} updateFormData={set} />
          ...
          <div className="space-y-4 pt-2 border-t border-slate-100">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <InputField label="Title" field="title" placeholder="e.g. Senior Trainer" formData={form} errors={profileFieldErrors} updateFormData={set} required={false} />
          ...
          <div className="flex gap-2 border-t border-slate-100 pt-5">
            <Button text="Cancel" variant="ghost" onClick={() => navigate("/admin/users")} className="flex-1 py-2.5" />
