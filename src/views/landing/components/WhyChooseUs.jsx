    ...
    <section id="about" className="py-24 px-6 bg-white">
      <div className="mx-auto max-w-7xl grid gap-12 lg:grid-cols-2 items-center">
        <div className="sr">
          ...
          <h2 className="mb-6 text-4xl font-black text-slate-900 md:text-5xl leading-tight">
        ...
        <div className="sr relative flex items-center justify-center h-80">
          <div className="absolute top-0 right-4 w-52 rounded-2xl bg-slate-900 p-5 shadow-xl rotate-3 hover:rotate-0 transition-transform duration-500">
