    ...
    <div className="mb-4">
      ...
      <div className="relative mt-2">
        <input
          ...
          className={`flex h-12 w-full items-center rounded-md border p-3 pr-10 text-p2 text-sm outline-none transition-colors focus:outline-none focus:ring-1 focus:ring-brand-500 ${
