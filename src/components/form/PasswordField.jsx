    ...
    <div className="mb-4">
      ...
      <div className="relative">
        <input
          ...
          className={`h-12 w-full rounded-xl border px-3 pr-10 text-sm text-blueSecondary outline-none transition-all placeholder:text-slate-400 focus:outline-none ${
            error
